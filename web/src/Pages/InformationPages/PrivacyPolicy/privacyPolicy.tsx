        ...
        <Col span={20}>
          ...
          <div className="privacy-body">
            ...
            <p>
              ...
              contact us at nce.digital@undp.org.
            </p>
          </div>
        </Col>
      </Row>
          ...
          <div className="privacy-body">
            <p>
              <b>
                ...
                by using our table of contents below to find the section you are looking for. You
                can also click<a href="#toc"> here</a> to go directly to our table of contents.
              </b>
            </p>
            <p>
            ...
            <p>
              <b>In what situations and with which parties do we share personal information?</b> We
            ...
            <p>
              ...
              <a href="https://app.termly.io/notify/d2782ea2-96ee-43e9-96de-b60955f40192"> here</a>,
        ...
        <Col span={20}>
          ...
          <div className="privacy-body">
            ...
            <ul>
              ...
              <li>
                <b>To determine the effectiveness of our marketing and promotional campaigns.</b> We
        ...
        <Col span={20}>
          ...
          <div className="privacy-body">
            ...
            <p>
              ...
              not apply to the personal information we process as a “data processor” on behalf of
              our customers. In those situations, the customer that we provide services to and with
              whom we have entered into a data processing agreement is the “data controller”
              responsible for your personal information, and we merely process your information on
              their behalf in accordance with your instructions. If you want to know more about our
            ...
            <p>
              ...
              withdraw your consent at any time. Click <a href="#withdrawconsent">here</a> to learn
              more.
            </p>
            <p>
        ...
        <Col span={20}>
          ...
          <div className="privacy-body">
            ...
            <p>
              ...
              collected from children under age 18, please contact us at info@panos.org.zm.
            </p>
          </div>
        </Col>
      </Row>
        ...
        <Col span={20}>
          ...
          <div className="privacy-body">
            ...
            <table border={1}>
              ...
              <tr>
                <td className="table-row1">K. Inferences drawn from other personal information</td>
                <td className="table-row1">
            ...
            <p>
              To exercise these rights, you can contact us Social Media Profiles, or by referring to
              the contact details at the bottom of this document. If you have a complaint about how
          ...
          <div className="privacy-body">
            ...
            <p>
              <b>
                ...
                Development Programme has appointed DPO to be its representative in the EEA. You can
                contact them directly regarding the processing of your information by United Nations
                Development Programme, or by post to:
              </b>
            </p>
          </div>
        </Col>
