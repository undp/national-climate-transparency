...
const LayoutActionModel: FC<LayoutActionProps> = (props: LayoutActionProps) => {
  const { t, actionInfo, onActionConfirmed, onActionCanceled, openModal, errorMsg, loading } =
    props;
...
export default LayoutActionModel;
