        ...
        <Col span={20}>
          ...
          <div className="term-body">
            <p>
              ...
              personally or on behalf of an entity (“you”) and United Nations Development Programme
            ...
            <p>
              ...
              such change. Please ensure that you check the applicable Terms every time you use our
      ...
      <Row justify="center">
        <Col span={20}>
          ...
          <div className="term-body">
            ...
            <a href="https://creativecommons.org/licenses/by/4.0/">appropriate credit</a>, provide a
            link to the license, and indicate if changes were made. You may do so in any reasonable
            manner, but not in any way that suggests the licensor endorses you or your use <br />⦾
            No additional restrictions — You may not apply legal terms or technological measures
            that legally restrict others from doing anything the license permits. Unless otherwise
            ...
            on the Site (collectively, the “Content”) and the trademarks, service marks, and logos
        ...
        <Col span={20}>
          ...
          <div className="term-body">
            <p>
              ...
              or non-human means, whether through a bot, script, or otherwise; (4) you will not use
              the Site for any illegal or unauthorized purpose; and (5) your use of the Site will
        ...
        <Col span={20}>
          ...
          <div className="term-body">
            <p>
              ...
              /privacy-policy. By using the Site, you agree to be bound by our Privacy Policy, which
              is incorporated into these Terms of Use. Please be advised the Site is hosted in the
              United States. If you access the Site from any other region of the world with laws or
              ...
              Site, you are transferring your data to the United States, and you agree to have your
        ...
        <Col span={20}>
          ...
          <div className="term-body">
            <p>
              ...
              MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE ANY CONTENT OR
              INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.
              <br /> If we terminate or suspend your account for any reason, you are prohibited from
        ...
        <Col span={20}>
          ...
          <div className="term-body">
            <p>
              ...
              be entirely performed within the State of New York, without regard to its conflict of
              law principles.
            </p>
          </div>
        </Col>
        ...
        <Col span={20}>
          ...
          <div className="term-body">
            <p>
              ...
              arbitration will take place in Manhattan, New York. Except as otherwise provided
            ...
            <p>
              ...
              shall be commenced or prosecuted in the state and federal courts located in Manhattan,
              New York, and the Parties hereby consent to, and waive all defenses of lack of
