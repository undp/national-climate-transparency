...
import { MrvStatsCardsTypes, SystemNames } from '../../Enums/statsCards.type.enum';
import { MapSourceData, MapTypes, MarkerData } from '../../Definitions/mapComponent.definitions';
...
export const MrvDashboardComponent = (props: any) => {
  const { Link, Chart, t, ButtonGroup, isMultipleDashboardsVisible = false } = props;
