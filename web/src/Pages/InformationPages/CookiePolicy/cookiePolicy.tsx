      ...
      <Row justify="center">
        <Col span={20}>
          ...
          <div className="cookie-body">
            ...
            <br /> (please note that the specific cookies served may vary depending on the specific
      ...
      <Row justify="center">
        <Col span={20}>
          ...
          <div className="cookie-card-subtitle-text">
            ...
            are properly displayed for advertisers, and in some cases selecting advertisements that
      ...
      <Row justify="center">
        <Col span={20}>
          ...
          <div className="cookie-body">
            ...
            identifier that enable us to recognize when someone has visited our Websites or opened
            an e-mail including them. This allows us, for example, to monitor the traffic patterns
            of users from one page within a website to another, to deliver or communicate with
            cookies, to understand whether you have come to the website from an online advertisement
      ...
      <Row justify="center">
        <Col span={20}>
          ...
          <div className="cookie-body-contact">
            ...
            <a href="https://termly.io/products/cookie-consent-manager/">Cookie Consent Manager</a>.
          </div>
        </Col>
      </Row>
    </div>
